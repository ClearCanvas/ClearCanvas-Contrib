...
namespace AIM.Annotation.View.WinForms
{
	partial class DropDownEntity
	{
		...
		private void InitializeComponent()
		{
			...
			this._ddlEntity = new System.Windows.Forms.ComboBox();
			...
			// _ddlEntity
			// 
			this._ddlEntity.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this._ddlEntity.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this._ddlEntity.FormattingEnabled = true;
			this._ddlEntity.Location = new System.Drawing.Point(4, 30);
			this._ddlEntity.Margin = new System.Windows.Forms.Padding(4);
			this._ddlEntity.Name = "_ddlEntity";
			this._ddlEntity.Size = new System.Drawing.Size(137, 24);
			this._ddlEntity.TabIndex = 1;
			this._ddlEntity.DropDown += new System.EventHandler(this.OnDropDown);
			// 
			// _toolTip
			// 
			...
			this._lblEntity.Location = new System.Drawing.Point(1, 4);
			...
			this._lblEntity.Size = new System.Drawing.Size(41, 18);
			this._lblEntity.TabIndex = 0;
			...
			this.Controls.Add(this._ddlEntity);
			this.Controls.Add(this._lblEntity);
			this.Margin = new System.Windows.Forms.Padding(4);
			this.Name = "DropDownEntity";
		...
		private AIM.Annotation.View.WinForms.ToolTipLinkLabel _lblEntity;
		private System.Windows.Forms.ComboBox _ddlEntity;
