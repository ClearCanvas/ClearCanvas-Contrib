...
namespace AIM.Annotation.View.WinForms
{
    ...
    public partial class AimAnnotationDetailsComponentControl : ApplicationComponentUserControl
    {
            ...
            :base(component)
        {
        	...
        	this._tabAnatomicEnities.SuspendLayout();
			...
			this._tabAnatomicEnities.Controls.Add(_anatomicEntitiesDetailsControl);
        	...
        	this._tabAnatomicEnities.ResumeLayout(false);
