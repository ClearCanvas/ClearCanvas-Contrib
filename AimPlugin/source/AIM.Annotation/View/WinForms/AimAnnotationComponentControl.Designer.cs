...
namespace AIM.Annotation.View.WinForms
{
	partial class AimAnnotationComponentControl
	{
		...
		private void InitializeComponent()
		{
			...
			this._lblAnnotationType = new System.Windows.Forms.Label();
			this.SuspendLayout();
			// 
			// _cmbAnnotationType
			// 
			...
			this._cmbAnnotationType.Location = new System.Drawing.Point(144, 5);
			this._cmbAnnotationType.Name = "_cmbAnnotationType";
			this._cmbAnnotationType.Size = new System.Drawing.Size(390, 24);
			this._cmbAnnotationType.TabIndex = 0;
			this._cmbAnnotationType.SelectedValueChanged += new System.EventHandler(this._cmbAnnotationType_SelectedValueChanged);
			this._cmbAnnotationType.DropDown += new System.EventHandler(this._cmbAnnotationType_DropDown);
			// 
			// _lblAnnotationType
			// 
			this._lblAnnotationType.AutoSize = true;
			this._lblAnnotationType.BackColor = System.Drawing.Color.Transparent;
			this._lblAnnotationType.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F);
			this._lblAnnotationType.Location = new System.Drawing.Point(4, 8);
			this._lblAnnotationType.Name = "_lblAnnotationType";
			this._lblAnnotationType.Size = new System.Drawing.Size(134, 20);
			this._lblAnnotationType.TabIndex = 1;
			this._lblAnnotationType.Text = "Annotation Type:";
			// 
			...
			this.Controls.Add(this._lblAnnotationType);
		...
		private System.Windows.Forms.Label _lblAnnotationType;
