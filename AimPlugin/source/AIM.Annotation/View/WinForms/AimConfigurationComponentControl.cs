...
namespace AIM.Annotation.View.WinForms
{
	...
	public partial class AimConfigurationComponentControl : ApplicationComponentUserControl
	{
			...
			: base(component)
		{
			...
			_txtLocalFolderLocation.DataBindings.Add("Text", _component, "LocalAnnotationStoreFolder", true, DataSourceUpdateMode.OnPropertyChanged);
			_txtLocalFolderLocation.DataBindings.Add("Enabled", _component, "LocalAnnotationStoreFolderEnabled", false, DataSourceUpdateMode.OnPropertyChanged);

			_btnBrowseForFolder.DataBindings.Add("Enabled", _component, "LocalAnnotationStoreFolderEnabled", false, DataSourceUpdateMode.OnPropertyChanged);

			base.ErrorProvider.SetIconAlignment(_btnBrowseForFolder, ErrorIconAlignment.BottomRight);
		...
		private void _btnBrowseForFolder_Click(object sender, EventArgs e)
		{
			string initialFolder = _txtLocalFolderLocation.Text.Trim();
			...
			{
				_txtLocalFolderLocation.Text = this._folderBrowserDialog.SelectedPath;
			}
		}
	}
}
