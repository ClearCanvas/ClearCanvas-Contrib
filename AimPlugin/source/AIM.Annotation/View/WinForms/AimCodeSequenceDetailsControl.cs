...
namespace AIM.Annotation.View.WinForms
{
	...
	public partial class AimCodeSequenceDetailsControl : UserControl, INotifyPropertyChanged
	{
		...
		// This method sets internal collection of ICodeSequence items via reflection
		public IEnumerable SetupCodeSequenceList
		{
			...
			set
			{
				...
				if (propInfo != null)
				{
					try
					{
						this.CodeSequenceList = propInfo.GetValue(_component, null) as IList<aim_dotnet.ICodeSequence>;
					}
					catch (Exception)
					{
