...
namespace AIM.Annotation.View.WinForms
{
    partial class AimAnnotationsListComponentControl
    {
        ...
        {
			this._aimDetailsListControl = new AIM.Annotation.View.WinForms.AimDetailsListControl();
			this.SuspendLayout();
			// 
			// _aimDetailsListControl
			// 
			this._aimDetailsListControl.AvailableAnnotations = null;
			this._aimDetailsListControl.Dock = System.Windows.Forms.DockStyle.Fill;
			this._aimDetailsListControl.Location = new System.Drawing.Point(0, 0);
			this._aimDetailsListControl.Name = "_aimDetailsListControl";
			this._aimDetailsListControl.SelectedAnnotation = null;
			this._aimDetailsListControl.Size = new System.Drawing.Size(200, 300);
			this._aimDetailsListControl.TabIndex = 0;
			// 
			// AimAnnotationsListComponentControl
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(8F, 16F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this._aimDetailsListControl);
