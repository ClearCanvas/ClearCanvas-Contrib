...
namespace AIM.Annotation
{
   ...
   //     public static StandardCodeSequence CalculationCodeForStandardDeviation = new StandardCodeSequence("113061", "Standard Deviation", "DCM");
        ...
        public static IEnumerable<StandardCodeSequence> AnnotationTypeCodeSequences
        {
            get
            {
            	foreach (StandardCodeSequence codeSequencesVasari in AnnotationTypeCodeSequencesVasari)
            	{
            		yield return codeSequencesVasari;
            	}

            	foreach (StandardCodeSequence codeSequencesStandard in AnnotationTypeCodeSequencesStandard)
            	{
            		yield return codeSequencesStandard;
            	}
            }
        }

        public static IEnumerable<StandardCodeSequence> AnnotationTypeCodeSequencesVasari
        {
            get
            {
				// VASARI - March 2010 default private code
            	yield return new StandardCodeSequence("TCGA_2010", "Brain tumor target lesion", "VASARI");

                // VASARI - non-standard
				//yield return new StandardCodeSequence("IPAD4", "Brain tumor baseline target lesion", "IPAD");
				//yield return new StandardCodeSequence("IPAD5", "Brain tumor follow-up target lesion", "IPAD");
            }
        }

    	public static IEnumerable<StandardCodeSequence> AnnotationTypeCodeSequencesStandard
    	{
    		get
    		{
                // Context ID 6144
                ...
                yield return new StandardCodeSequence("112041", "Target Lesion Complete Response", "DCM");
                yield return new StandardCodeSequence("112042", "Target Lesion Partial Response", "DCM");
                yield return new StandardCodeSequence("112043", "Target Lesion Progressive Disease", "DCM");
                yield return new StandardCodeSequence("112044", "Target Lesion Stable Disease", "DCM");
                yield return new StandardCodeSequence("112045", "Non-Target Lesion Complete Response", "DCM");
                yield return new StandardCodeSequence("112046", "Non-Target Lesion Incomplete Response or Stable Disease", "DCM");
                yield return new StandardCodeSequence("112047", "Non-Target Lesion Progressive Disease", "DCM");

                // Context ID 6145
                // Baseline Category
                // Type: Extensible Version: 20030108
                // Note: From RECIST
                yield return new StandardCodeSequence("112074", "Target Lesion at Baseline", "DCM");
                yield return new StandardCodeSequence("112075", "Non-Target Lesion at Baseline", "DCM");
                yield return new StandardCodeSequence("112076", "Non-Lesion at Baseline", "DCM");

                // Context ID 7010
                // Key Object Selection Document Title
                yield return new StandardCodeSequence("113004", "For Teaching", "DCM");
    		}
    	}

    	public static bool IsAnnotationTypeStandard(StandardCodeSequence codeSequence)
    	{
    		return CollectionUtils.Contains(AnnotationTypeCodeSequencesStandard, p => p.Equals(codeSequence));
    	}
