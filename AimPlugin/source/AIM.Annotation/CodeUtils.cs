...
namespace AIM.Annotation
{
	...
	{
		public static AnatomicEntity ToAnatomicEntity(StandardCodeSequence codeSequence)
		{
		...
		public static ImagingObservation ToImagingObservation(StandardCodeSequence codeSequence)
		{
			return codeSequence == null
					? null
